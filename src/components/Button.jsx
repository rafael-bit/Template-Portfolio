...
const Button = () => {
    ...
    return (
        <button
            onClick={toggleTheme}
            className='bg-gray-800 dark:bg-gray-50 hover:bg-gray-600 dark:hover:bg-gray-300 transition-all duration-100 text-white dark:text-gray-800 p-2 text-l rounded-lg'
        >
            {theme === 'dark' ? (
